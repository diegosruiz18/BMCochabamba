...
export class FlujoDetallePedidoComponent implements OnInit {
  ...
  send(): any {
    ...
    this.pedidoTemporalService.agregarPedidoTemporal(this.productosModal,this.subtotal,
      this.formLogin.value.type,this.total,this.costoEnvio,this.formLogin.value.direccion,
      this.formLogin.value.ciudad,this.formLogin.value.pais);
    //agregando a BD 
    this.agregarPedido();
    //cerrando modal
  ...
  agregarPedido() {
    let data = {
      ...
      pais: this.formLogin.value.pais,
      provincia: this.formLogin.value.provincia,
      ciudad: this.formLogin.value.ciudad,
      codigoPostal: this.formLogin.value.codigopostal,
      courier: this.formLogin.value.type,
